...
function getApplicableCorridors(originRegion, destRegion) {
...
const transportModes = ['Ship/Ocean', 'Air', 'Train'];

const insuranceCostMatrix = {
  'Ship/Ocean': {
...
function getInsuranceCostPct(transportMode, originRegion, destRegion) {
...
function getShippingCostPct(transportMode, originRegion, destRegion) {
...
function getTariffRate(destCountry, hsCode, originCountryCode) {
...
function getOtherDutiesPct(destCountry) {
